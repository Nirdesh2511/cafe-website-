                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <p>
                                One thing to note is that kapetann can get quite busy during peak hours, so it's advisable to make a reservation or arrive early to secure a table. 
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/quote-img.png" alt="" class="quote">
                                <p>
                                "kapetanncoffee exudes a trendy vibe, serving delectable coffee and a variety of tasty treats. Perfect place for a cafe hopping."
...
.
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/quote-img.png" alt="" class="quote">
                                <p>
                                "Cafe Kaptann offers a cozy ambiance,delicious menu with diverse options,excellent service . Highly recommended for coffee lovers."
        ...
        <section class="footer">
            <div class="footer-container">
                <div class="logo">
                    ...
                    <p>patelnirdesh2@gmail.com</p><br />
                    <i class="fas fa-phone"></i>
                    <p>+91 0265-266-0951</p><br />
                ...
                <div class="credit">
                    ...
                    <h2>Designed by <span>Nirdesh patel</span> | Teravision</h2>
                </div>
            </div>
        </section>
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
        center: {lat: 22.3072, lng: 73.1812}, // Vadodara, Gujarat, India
        zoom: 9
    });

    var marker = new google.maps.Marker({
        position: {lat: 22.3072, lng: 73.1812}, // Vadodara, Gujarat, India
        map: map,
        title: 'Your Location'
    });
}
